...
exports.activate = exports.MMOItemsSyntaxProvider = void 0;
...
function activate(context) {
    ...
    context.subscriptions.push(vscode.languages.registerDocumentSemanticTokensProvider({ language: 'yaml' }, provider, MMOItemsSyntaxProvider.legend // ⚠️ Fix lỗi legend bị private
    ));
}
